...
const howItWorks = [
	{
		...
		title: "Create",
		description:
			"Build your survey with questions and options. Set access type and display mode.",
	},
	{
		step: "02",
		title: "Share",
		description:
			"Publish your survey and share the link with your audience — public or private.",
	},
	{
		step: "03",
		title: "Collect",
		description:
			"Responses come in. Track completion in real time as people submit.",
	},
	{
		step: "04",
		title: "Analyze",
		description:
			"View aggregated stats — counts, percentages, and who responded.",
	},
];
		...
		<div className="relative min-h-screen bg-background text-foreground overflow-hidden">
			...
			<section className="relative z-10 flex flex-col items-center justify-center text-center px-6 pt-28 pb-20">
				...
				<p className="mt-6 text-muted-foreground text-lg max-w-xl leading-relaxed">
					A clean, focused survey platform built for people who want
					real insights without the bloat. No unnecessary features —
					just what matters.
				</p>
			...
			<section className="relative z-10 max-w-3xl mx-auto px-6 py-20 text-center">
				...
				<p className="text-muted-foreground text-base leading-relaxed">
					Most survey tools are either too simple or too overwhelming.
					We built SurveyApp to sit in the middle — enough power to
					get real data, simple enough that anyone can use it without
					a tutorial. Whether you&apos;re collecting feedback, running
					a poll, or researching your audience, SurveyApp gets out of
					your way and lets the data speak.
				</p>
			</section>
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
					{howItWorks.map((item, i) => (
						<div key={item.step} className="relative flex flex-col">
							...
							<span className="text-4xl font-black text-primary/15 mb-3 leading-none">
								{item.step}
							</span>
			...
			<section className="relative z-10 max-w-2xl mx-auto px-6 pb-28 text-center">
				<div className="rounded-2xl border border-primary/20 bg-primary/5 p-10">
					...
					<p className="text-muted-foreground text-sm mb-7">
						Create your first survey in under a minute. No credit
