...
import { Loader2, Settings2, Type, AlignLeft, RefreshCw, BarChart } from "lucide-react";
...
export function SurveyEditForm({
	...
	return (
		<Card className="border-2 border-primary/20 shadow-lg">
			<CardHeader className="bg-linear-to-r from-blue-50 to-purple-50 dark:from-blue-950/30 dark:to-purple-950/30 border-b">
				...
				<form onSubmit={onSave} className="space-y-6">
					...
					<div className="space-y-3">
						<div className="flex items-center gap-2">
							...
							<Label htmlFor="survey_title" className="text-base font-medium">
								Title
							</Label>
						</div>
						<Input
						...
						<p className="text-xs text-muted-foreground">
							A clear title helps respondents understand your survey
						</p>
					</div>
					...
					<div className="space-y-3">
						<div className="flex items-center gap-2">
							...
							<Label htmlFor="survey_description" className="text-base font-medium">
								Description
							</Label>
						</div>
						<Textarea
					...
					<div className="space-y-4 pt-4 border-t">
						...
						<div className="flex items-start gap-3 p-3 rounded-lg border hover:bg-accent/50 transition-colors">
							<Checkbox
								id="allow_multiple"
								checked={surveyForm.allow_multiple_responses || false}
								onCheckedChange={(checked) =>
									onUpdate("allow_multiple_responses", checked)
								}
							...
							<div className="space-y-1">
								...
								<p className="text-xs text-muted-foreground">
									Respondents can submit this survey multiple times
								</p>
							</div>
						</div>
